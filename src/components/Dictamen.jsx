...
const Dictamen = () => {
  ...
  const enviarCorreo = async () => {
    ...
    try {
      ...
      const documentoResponse = await axios.post(`https://8080-cs-106689005237-default.cs-us-east1-pkhd.cloudshell.dev/api/documento/${nroDoc}/actualizarDictamen`, dataToSendDoc);
